...
| `--cys-ss-pka` | 99.99 | PROPKA pKa threshold above which CYS is renamed to CYX (disulfide-bonded). Matches PROPKA's own sentinel; explicit CONECT-detected SS pairs override this regardless. |
