...
_CATEGORY_HEADINGS: dict[str, str] = {
    ...
    "ramachandran_outlier": "Chemistry / bond geometry",
    "sidechain_chi12_outlier": "Chemistry / bond geometry",
...
_FIX_TOOL: dict[str, str] = {
    ...
    "ramachandran_outlier": "manual: rebuild or refine the local backbone geometry",
    "sidechain_chi12_outlier": "manual: rebuild or refine the side-chain conformation",
